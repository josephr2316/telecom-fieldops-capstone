...
export const transitions: Record<WorkOrderType, Partial<Record<WorkOrderStatus, WorkOrderStatus[]>>> = {
  ...
  CLAIM_TROUBLESHOOT: {
    ...
    IN_PROGRESS: ['VERIFICATION', 'INVENTORY_RESERVATION', 'CANCELLED'],
    INVENTORY_RESERVATION: ['IN_PROGRESS', 'ON_HOLD', 'CANCELLED'],
  ...
  PLAN_AND_EQUIPMENT_SALE: {
    ...
    FULFILLMENT: ['VERIFICATION', 'ON_HOLD', 'DELIVERY', 'SCHEDULED', 'IN_PROGRESS', 'CANCELLED'],
